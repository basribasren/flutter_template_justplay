import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/slidergroup427319005_item_model.dart';import '../models/listall_item_model.dart';import '../models/listrectangle_item_model.dart';import '../models/listrectanglefive_item_model.dart';import 'package:basri_s_application23/presentation/home_page/models/home_model.dart';part 'home_event.dart';part 'home_state.dart';class HomeBloc extends Bloc<HomeEvent, HomeState> {HomeBloc(HomeState initialState) : super(initialState) { on<HomeInitialEvent>(_onInitialize); }
